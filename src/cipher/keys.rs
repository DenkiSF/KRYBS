...
impl Keys {
    ...
    fn feistel(left: [u8; BLOCK_SIZE], right: [u8; BLOCK_SIZE], base_iter: usize,
               consts: &[[u8; BLOCK_SIZE]; 32]) -> [[u8; BLOCK_SIZE]; 2] {
...
mod tests {
    ...
    fn test_round_keys() {
        ...
        for i in 1..=10 {
            assert_eq!(keys.get_round_key(i), expected_keys[i - 1],
                       "Round key {} mismatch", i);
        }
    }
}