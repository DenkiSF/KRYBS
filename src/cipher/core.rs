...
mod tests {
    ...
    fn test_mgm_official_vector() {
        ...
        // Данные
        let aad = hex::decode("02020202020202020101010101010101\
                            04040404040404040303030303030303\
                            ea0505050505050505").unwrap();
        let plaintext = hex::decode("1122334455667700ffeeddccbbaa9988\
                                    00112233445566778899aabbcceeff0a\
                                    112233445566778899aabbcceeff0a00\
                                    2233445566778899aabbcceeff0a0011\
                                    aabbcc").unwrap();

        let expected_ct = hex::decode("a9757b8147956e9055b8a33de89f42fc\
